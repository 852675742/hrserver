...
public class SystemBasicController {
    ...
    //测试用
    @RequestMapping(value = "/getDepById/{id}", method = RequestMethod.GET)
    public Department getDepById(@PathVariable Long id) {
        return departmentService.getDepById(id);
    }

    //测试用
    @RequestMapping(value = "/updateDepById/{id}", method = RequestMethod.GET)
    public Department updateDepById(@PathVariable Long id) {
         return departmentService.update(id);
    }

    //测试用
    @RequestMapping(value = "/delDepById/{id}", method = RequestMethod.GET)
    public void delDepById(@PathVariable Long id) {
